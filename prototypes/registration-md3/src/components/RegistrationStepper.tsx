		...
		<Box>
			...
			>
				{steps.map((stepItem, i) => {
					...
					const clickable =
						Boolean(onStepClick) && stepNumber <= maxStep;
					const { Icon } = stepItem;
					return (
						<Box key={stepItem.key} sx={{ display: 'contents' }}>
							...
							<Box
								...
								aria-label={t(`reg.stepNames.${stepItem.key}`)}
								...
								sx={{
									...
									'outline': 'none',
									'&:focus-visible': {
										boxShadow: `0 0 0 2px ${md3.primary}`
									},
									'&:hover .step-dot': clickable
								...
								<Box
									...
									sx={{
										...
										border:
												...
												? 'none'
												: `1.5px solid ${md3.outlineVariant}`,
										boxShadow: active
											? `0 0 0 4px ${md3.selectedLayer}`
											: 'none'
									}}
								>
									{done ? (
