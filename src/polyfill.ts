...
const findDOMNodeFallback = (componentOrElement: any): Element | null => {
...
const reactDOMMaybeWithFindDomNode = ReactDOM as typeof ReactDOM & {
	findDOMNode?: (componentOrElement: any) => Element | null;
};

export const findDOMNode =
	reactDOMMaybeWithFindDomNode.findDOMNode || findDOMNodeFallback;

export const reactDOMWithFindDomNode = Object.assign({}, ReactDOM, {
	findDOMNode
});
