...
- List snap (checklist 7): `SessionsListWrapper` derives `panelOpen` from `ChatStagePanelContext`, which reports the pane the card actually shows, and `resolveStageLayout` — the list column snaps to the
