		...
		docs: {
			description: {
				component: [
					...
					'`carrierPresence.ts` holds publicly documented seats and focus',
					'regions, **not** the platform’s own agency records. No carrier',
					'covers the whole country — the white patches are deliberate, and',
					'they are what makes the combined coverage believable.',
					'',
