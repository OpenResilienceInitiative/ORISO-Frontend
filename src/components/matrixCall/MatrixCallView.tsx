...
export const MatrixCallView: React.FC<MatrixCallViewProps> = ({
	...
	useEffect(() => {
		...
		if (!client) {
			console.error('Matrix client not ready');
			return;
		}
		...
		if (isAnswering && incomingCall) {
			...
			console.error('No incoming call found to answer');
		}
		...
		<div className="matrix-call">
			...
			<div className="matrix-call__controls">
				...
				<div className="matrix-call__control-group">
					...
					<svg
						className="matrix-call__dropdown-caret"
						width="10"
						height="6"
						viewBox="0 0 10 6"
						fill="currentColor"
					...
					<div className="matrix-call__control-group">
						...
						>
							<svg
								...
								height="20"
								viewBox="0 0 24 24"
								fill={isVideoMuted ? 'none' : 'currentColor'}
								stroke={isVideoMuted ? 'currentColor' : 'none'}
							>
