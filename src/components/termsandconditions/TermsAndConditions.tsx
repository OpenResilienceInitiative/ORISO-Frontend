...
export const TermsAndConditions = () => {
	...
	const transformText2DataPrivacyLink = (text: string) => {
		...
		// Resolved centrally so the container runtime config wins and the
		// fallback stays on this platform's own /datenschutz route — never on
		// a third party's privacy policy (FE-H05, #178).
