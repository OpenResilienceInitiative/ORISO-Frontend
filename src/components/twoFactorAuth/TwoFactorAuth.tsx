...
export const TwoFactorAuth = () => {
	...
	const selectTwoFactorTypeButtons = useCallback((): React.ReactElement => {
		return (
	...
	/* APP */
	const getAuthenticatorTools = useCallback((): React.ReactElement => {
		const tools = [
			{
				title: translate(
	...
	const connectAuthAccount = useCallback((): React.ReactElement => {
		return (
	...
	const appConfirmation = useCallback((): React.ReactElement => {
		return (
	...
	const emailSelection = useCallback((): React.ReactElement => {
		return (
	...
	const emailCodeInput = useCallback((): React.ReactElement => {
		return (
	...
	const emailConfirmation = useCallback((): React.ReactElement => {
		return (
