...
export const LegalLinkModal = ({
	...
	return (
		...
		>
			{scope === 'platform' ? (
				<div className="legalLinkModal__platformNote">
					<p>{translate(platformLegalNoteKey(kind))}</p>
				...
				/* pre-dev 74b3b152 "never show an invented legal text to a
				   help-seeker": with no stored text we must NOT fall back to
				   canned content — say it is missing and offer the stored
				   address instead. The platform-scope branch above is the demo
				   branch's addition and keeps its own note. */
				<div
