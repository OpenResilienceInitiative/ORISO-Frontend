...
export const OrisoDialog = ({
	...
	const resolvedBack = backLabel ?? t('form.dialog.back');
	const resolvedConfirm = confirmLabel ?? t('form.dialog.confirm');
	return (
		<Dialog
			open={open}
			onClose={onClose}
		...
		>
			...
			>
				<IconButton
					aria-label={t('form.dialog.close')}
					onClick={onClose}
					sx={{
						position: 'absolute',
						top: 10,
