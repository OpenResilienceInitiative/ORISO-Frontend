...
const EMAIL_PROTECTED_EXTRA: Partial<Record<EmailId, readonly string[]>> = {
	...
	// Call notifications intentionally withhold names, topics and participant data.
	'anruf-erinnerung': ['paragraphs.*', 'footnote'],
	'anruf-einladung': ['paragraphs.*', 'footnote'],
	'anruf-verpasst': ['paragraphs.*', 'footnote'],
