...
export const ru: Record<EmailId, EmailContent> = {
	...
	'avv-unterschrift': {
		...
		headline: 'Договорные документы готовы к подписанию',
		paragraphs: [
			'Для {{tenantName}} подготовлены договорные документы.',
			'Пожалуйста, проверьте документы и подпишите их в электронном виде.'
		],
		panel: [
			{ label: 'Организация', value: '{{tenantName}}' },
		...
		footnote:
			'Без подписанных договорных документов консультации для этой организации останутся заблокированными.',
