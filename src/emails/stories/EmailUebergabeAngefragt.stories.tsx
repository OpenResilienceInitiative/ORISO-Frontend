...
const meta = {
	title: 'Email/Pages/UebergabeAngefragt',
	component: EmailPage,
	argTypes: emailPageArgTypes,
	args: { id: 'uebergabe-angefragt' as const, locale: 'de-sie' as const },
	tags: ['autodocs'],
	parameters: {
		docs: {
			description: {
				component:
					'The request half of a case handover. Nothing has moved yet, which is what the footnote says — a counsellor who reads this on a phone and does nothing has not accidentally dropped a case.'
			}
		}
	}
