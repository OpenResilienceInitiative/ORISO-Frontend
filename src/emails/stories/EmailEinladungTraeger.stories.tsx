...
const meta = {
	title: 'Email/Pages/EinladungTraeger',
	component: EmailPage,
	argTypes: emailPageArgTypes,
	args: { id: 'einladung-traeger' as const, locale: 'de-sie' as const },
	tags: ['autodocs'],
	parameters: {
		docs: {
			description: {
				component:
					'Account creation for a Träger administrator. Everything it names is an organisation and a deadline — never a person seeking advice.'
			}
		}
	}
