...
const meta = {
	title: 'Email/Pages/Rueckmeldung',
	component: EmailPage,
	argTypes: emailPageArgTypes,
	args: { id: 'rueckmeldung' as const, locale: 'de-sie' as const },
	tags: ['autodocs'],
	parameters: {
		docs: {
			description: {
				component:
					'A reply in the protected professional exchange — supervision and four-eyes review. The content stays encrypted; the mail says only that something is there. The footnote states the part counsellors most need to be sure of: the person seeking advice cannot see this channel.'
			}
		}
	}
