...
const meta = {
	title: 'Email/Pages/Systemhinweis',
	component: EmailPage,
	argTypes: emailPageArgTypes,
	args: { id: 'systemhinweis' as const, locale: 'de-sie' as const },
	tags: ['autodocs'],
	parameters: {
		docs: {
			description: {
				component:
					'Planned maintenance. The one mail with no personal relevance at all, which is exactly why it closes by promising that nothing already written is lost — a service interruption reads as data loss unless you say otherwise.'
			}
		}
	}
