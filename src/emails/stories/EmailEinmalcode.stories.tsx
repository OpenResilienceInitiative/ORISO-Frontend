...
const meta = {
	title: 'Email/Pages/Einmalcode',
	component: EmailPage,
	argTypes: emailPageArgTypes,
	args: { id: 'einmalcode' as const, locale: 'de-sie' as const },
	tags: ['autodocs'],
	parameters: {
		docs: {
			description: {
				component:
					'The 2FA one-time code, today rendered by the Keycloak theme (ORISO-Keycloak#13). The code sits in the panel and deliberately **not** in the subject line: a subject is readable on a locked screen, and a code that is readable there is one factor short of useless.'
			}
		}
	}
