...
const meta = {
	title: 'Email/Pages/PasswortZuruecksetzen',
	component: EmailPage,
	argTypes: emailPageArgTypes,
	args: { id: 'passwort-zuruecksetzen' as const, locale: 'de-sie' as const },
	tags: ['autodocs'],
	parameters: {
		docs: {
			description: {
				component:
					'Password reset. States the validity window twice — in the preview line and in the body — and explicitly tells a recipient who did not request it that ignoring the mail is safe, because a reset mail landing unexpectedly is alarming on its own.'
			}
		}
	}
