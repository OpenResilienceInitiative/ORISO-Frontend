...
const meta = {
	title: 'Email/Pages/EinladungFachkraft',
	component: EmailPage,
	argTypes: emailPageArgTypes,
	args: { id: 'einladung-fachkraft' as const, locale: 'de-sie' as const },
	tags: ['autodocs'],
	parameters: {
		docs: {
			description: {
				component:
					'The counsellor equivalent. The footnote states the condition up front, so nobody sets up a password and then discovers that two-factor sign-in is not optional.'
			}
		}
	}
