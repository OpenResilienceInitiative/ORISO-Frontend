...
const meta = {
	title: 'Email/Pages/UebergabeBestaetigt',
	component: EmailPage,
	argTypes: emailPageArgTypes,
	args: { id: 'uebergabe-bestaetigt' as const, locale: 'de-sie' as const },
	tags: ['autodocs'],
	parameters: {
		docs: {
			description: {
				component:
					'The confirmation half. Goes to the counsellor who handed over, and states plainly that their access to the conversation ends — that is a consequence worth reading in the mail rather than discovering in the app.'
			}
		}
	}
