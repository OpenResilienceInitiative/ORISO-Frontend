...
const meta = {
	title: 'Email/Pages/DirekteAnfrage',
	component: EmailPage,
	argTypes: emailPageArgTypes,
	args: { id: 'direkte-anfrage' as const, locale: 'de-sie' as const },
	tags: ['autodocs'],
	parameters: {
		docs: {
			description: {
				component:
					'Same arrival, one difference that changes the tone: this person chose *this* counsellor. The second paragraph exists because a direct enquiry that nobody picks up is worse than an unassigned one — it was addressed to someone.'
			}
		}
	}
