...
const meta = {
	title: 'Email/Pages/Willkommen',
	component: EmailPage,
	argTypes: emailPageArgTypes,
	args: { id: 'willkommen' as const, locale: 'de-sie' as const },
	tags: ['autodocs'],
	parameters: {
		docs: {
			description: {
				component:
					'Sent once, after anonymous registration. The only mail that prints the generated user name, because it cannot be recovered later — losing it means losing the account. Hence the data panel rather than a sentence: it has to survive being skim-read.'
			}
		}
	}
