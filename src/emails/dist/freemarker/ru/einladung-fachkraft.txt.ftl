...
Консультационный центр: ${agencyName!''}
Ссылка действует до: ${inviteExpiresAt!''}

Настроить доступ:
${inviteUrl!''}

Без двухфакторного входа доступ к консультациям невозможен.
