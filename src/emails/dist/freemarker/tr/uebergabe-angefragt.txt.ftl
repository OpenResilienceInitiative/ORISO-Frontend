Bir danışmanlığın size devredilmesi isteniyor
=============================================
...
Dosya: ${caseReference!''}
Talep eden: ${fromConsultantName!''}
Talep tarihi: ${requestReceivedAt!''}

Devri incele:
${requestUrl!''}

Siz onaylayana kadar danışmanlık mevcut uzmanda kalır.
